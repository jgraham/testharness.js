...
However, there is also a [nice HTML-based guide](http://darobin.github.com/test-harness-tutorial/docs/using-testharness.html) to using testharness. It also has lots of examples, etc.
